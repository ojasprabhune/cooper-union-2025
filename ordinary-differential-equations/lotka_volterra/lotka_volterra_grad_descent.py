...
fig.legend()
fig.savefig(
    "~/projects/cooper-union-2025/ordinary-differential-equations/lotka_volterra/graphs/rabbits.png"
)
...
fig.legend()
fig.savefig(
    "~/projects/cooper-union-2025/ordinary-differential-equations/lotka_volterra/graphs/foxes.png"
)
